            ...
            <div className="col-lg-3 col-md-6 col-sm-12 col-12">
              ...
              <div className="single-short-service-area-start">
                ...
                <div className="information">
                  ...
                  <p className="disc">
                    Enjoy exclusive discounts and amazing offers on a wide range
                    of grocery products, carefully prepared just for you.
                  </p>
                </div>
              </div>
            ...
            <div className="col-lg-3 col-md-6 col-sm-12 col-12">
              ...
              <div className="single-short-service-area-start">
                ...
                <div className="information">
                  ...
                  <p className="disc">
                    Shop with confidence! If you’re not satisfied with your
                    purchase, we offer a hassle-free 100% return policy on all
                    grocery products.
                  </p>
                </div>
              </div>
              ...
              <div className="single-short-service-area-start">
                ...
                <div className="information">
                  ...
                  <p className="disc">
                    ...
                    with your orders, inquiries, and service needs anytime.
                  </p>
                </div>
              </div>
              {/* single service area end */}
            ...
            <div className="col-lg-3 col-md-6 col-sm-12 col-12">
              ...
              <div className="single-short-service-area-start">
                ...
                <div className="information">
                  ...
                  <p className="disc">
                    Don’t miss out on our exclusive daily deals—enjoy fresh
                    discounts and exciting offers on grocery products every day!
                  </p>
                </div>
              </div>
              {/* single service area end */}
