...
const BlogGridMain: React.FC<BlogGridMainProps> = ({
  ...
  const handleAdd = () => {
    addToCart({
      ...
      image: ProductImage.startsWith('http') ? ProductImage : `/assets/images/grocery/${ProductImage}`,
      ...
      <div className="single-shopping-card-one discount-offer">
        <Link href={`/shop/${Slug}`} className="thumbnail-preview">
          ...
          <div style={{ width: "100%", height: "250px" }}>
            <img
              src={ProductImage.startsWith('http') ? ProductImage : `/assets/images/grocery/${ProductImage}`}
              alt="grocery"
        ...
        <div className="body-content">
          <div className="title-area-left">
            ...
            <div className="price-area">
              ...
              <div className="previous">₹ 100000.00</div>
            </div>
