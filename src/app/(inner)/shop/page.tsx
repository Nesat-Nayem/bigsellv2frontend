...
import CustomSidebar from "./SidebarFilter";
...
function ShopContent() {
  ...
  const paramsCategory =
    !pssc && !psc ? selectedCategoryId || pc || undefined : undefined;
  ...
  const items = useMemo(
    () => (paged?.items || []).map(transformProductToPost),
    [paged]
  );
                        ...
                        <div className="skeleton-content">
                          ...
                          <div className="skeleton-rating-row">
                            {[...Array(5)].map((_, i) => (
                              <div
                                key={i}
                                className="skeleton-star-modern"
                              ></div>
                            ))}
                          </div>
  ...
  return (
    <div className="shop-page">
      ...
      <div className="shop-grid-sidebar-area pt-3">
        <div className="container">
          <div className="row g-0">
            {/* Sidebar */}
            <CustomSidebar
            ...
            <div className="col-xl-9 col-lg-12">
              <div className="filter-select-area">
                <div className="top-filter">
                  <span>
                    Showing {items.length > 0 ? `${startIdx}-${endIdx}` : 0} of{" "}
                    {meta.total} results
                  </span>
                  {/* <div className="right-end">
              ...
              <div className="tab-content" id="myTabContent">
                <div className="product-area-wrapper-shopgrid-list mt--20 tab-pane fade show active">
                  {activeTab === "tab1" && (
                    <div className="row g-4">
                      {items.length > 0 ? (
                        items.map((post: PostType, index: number) => {
                          return (
                            <div
                              key={index}
